...
let displayWeather = ({ location, current, forecast }) => {
  myRow.innerHTML = ` <!-- first section where we view the weather forecast of the current day -->
        <div id="weatherOfTheDay" class="col-md-3 d-flex flex-column gap-5">
          ...
          <span class="country text-capitalize">${location.country}</span></p>
          ...
          <div
            class="container details d-flex flex-row justify-content-start align-items-center gap-4"
          >
            <div class="wind secondary-color">
              <div class="">
                <p class="m-0">
                  <i class="fa-solid fa-wind"></i> <span>wind</span>
                </p>
              </div>
       ...
       <div class="col-md-6 d-flex justify-content-center align-items-center">
        ...
        <div
          class="position-relative col-md-3 d-flex justify-content-center align-items-start mt-5 mt-md-0"
        >
          <div class="forecast d-flex flex-column gap-4">
            </div>
          </div>`;
  // third section showing the forecast for the next 3 days
  let forecastContainer = myRow.querySelector(".forecast");
                ...
                <div class="d-flex gap-4">
                 ...
                 /></div>
                  <div class="details">
                    ...
                    <p class="secondary-color m-0">${day.day.condition.text}</p>
                  </div>
                </div>
